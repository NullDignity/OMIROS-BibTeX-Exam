...
int main() {
    ...
    string criteria_1, criteria_2;

    cout << "Please enter the first sorting criteria (type, id, author, year): ";
    cin >> criteria_1;
    transform(criteria_1.begin(), criteria_1.end(), criteria_1.begin(), ::toupper);

    while (criteria_1 != "TYPE" && criteria_1 != "ID" && criteria_1 != "AUTHOR" && criteria_1 != "YEAR") {
        system("cls");
    ...
    cout << "Please enter the second sorting criteria (type, id, author, year): ";
    cin >> criteria_2;
    transform(criteria_2.begin(), criteria_2.end(), criteria_2.begin(), ::toupper);

    while (criteria_2 != "TYPE" && criteria_2 != "ID" && criteria_2 != "AUTHOR" && criteria_2 != "YEAR") {
        system("cls");
        cout << "Error during input. Please enter the first sorting criteria again (type, id, author, year): ";
        cin >> criteria_2;
        transform(criteria_2.begin(), criteria_2.end(), criteria_2.begin(), ::toupper);
    ...
    function<bool(const BibElement&, const BibElement&)> comp = [&](const BibElement& a, const BibElement& b) {
        ...
        else if (criteria_1 == "ID") {
            if (a.getId() != b.getId())
                return a.getId() < b.getId();
        }
        else if (criteria_1 == "AUTHOR") {
            if (a.getAuthor() != b.getAuthor())
                return a.getAuthor() < b.getAuthor();
        }
        else if (criteria_1 == "YEAR") {
